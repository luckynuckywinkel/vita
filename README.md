...
Ни находит ни одной строчки. Если заменить php7.4 просто на php - находит аж 6:  
...
Прошу прокомментировать и написать, если нужны какие-то дополнения, комментарии и прочее.  

Всю структуру работы я положил в этот git - репозиторий для вашего удобства.  

Старался сделать, как можно быстрее. Прошу прощения, если где-то вышло сумбурно.  
